 ...
 * system_entropies contains joint entropy at index N
 */
template<unsigned int S, bool ComputeTc, bool ComputeZI, bool ComputeSI, bool ComputeSI_2, bool HistogramOnly, bool ComputeMutualInformation>
 ...
 * system_entropies contains joint entropy at index N
 */
template<unsigned int S, bool ComputeZI,bool ComputeSI,bool ComputeSI_2, bool HistogramOnly, bool ComputeMutualInformation>
    __global__ void cluster_kernel_card(
    float* system_entropies,
    float* hsystem_stats,
    register_t* clusters,
    unsigned int* cluster_sizes,
    ...
    else
    {
	    ...
	    unsigned int sum_card=0;
            ...
            for (unsigned int v = 0; v != SP.N; ++v)
              if (dci::RegisterUtils::GetBitAtPos(cur_cluster, v))
	      {
                sum_card = sum_card + cardinalities[v]-1;
		prod_card= prod_card*cardinalities[v];
	      } */
 ...
 */
template<unsigned int S, bool ComputeZI,bool ComputeSI,bool ComputeSI_2, bool HistogramOnly, bool ComputeMutualInformation>
    __global__ void cluster_kernel_agent_pool(
    float* system_entropies,
    float* hsystem_stats,
    register_t* clusters,
    unsigned int* cluster_sizes,
