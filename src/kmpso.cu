  ...
  */
  void printUsage(char* command)
  {
    ...
    std::cout << "--dimension:number      search space dimension (default 16)\n";
    std::cout << "--swarm_size:number     swarm size (default 2000)\n";
    std::cout << "--n_seeds:number        number seeds (default 1)\n";
    ...
    std::cout << "--hseed:number          random seed for h. system computation (default equals rseed)\n";
    std::cout << "--inputfile             path to the input file\n";
  ...
  //debug  cout  << chosen_index << "\n";
    }
      else
   {outfile << chosen_index << "\tComp\n";
  //debug cout <<  chosen_index << "\tComp\n";
  }
